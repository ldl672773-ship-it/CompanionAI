...
const animationIn: Record<Direction, ComplexAnimationBuilder> = {
    left: SlideInLeft.duration(250).easing(Easing.bezier(0.25, 0.1, 0.25, 1)),
    right: SlideInRight.duration(250).easing(Easing.bezier(0.25, 0.1, 0.25, 1)),
    up: SlideInUp.duration(250).easing(Easing.bezier(0.25, 0.1, 0.25, 1)),
    down: SlideInDown.duration(250).easing(Easing.bezier(0.25, 0.1, 0.25, 1)),
}

const animationOut: Record<Direction, ComplexAnimationBuilder> = {
    left: SlideOutLeft.duration(200).easing(Easing.bezier(0.4, 0.0, 0.2, 1)),
    right: SlideOutRight.duration(200).easing(Easing.bezier(0.4, 0.0, 0.2, 1)),
    up: SlideOutUp.duration(200).easing(Easing.bezier(0.4, 0.0, 0.2, 1)),
    down: SlideOutDown.duration(200).easing(Easing.bezier(0.4, 0.0, 0.2, 1)),
}
